    ...
    public partial class mig_1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CarEngineTypeName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
            ...
            migrationBuilder.CreateTable(
                name: "AppUserUserImageFile",
                columns: table => new
                {
                    AppUsersId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    UserImageFilesId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserUserImageFile", x => new { x.AppUsersId, x.UserImageFilesId });
                    table.ForeignKey(
                        name: "FK_AppUserUserImageFile_AspNetUsers_AppUsersId",
                        column: x => x.AppUsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppUserUserImageFile_Files_UserImageFilesId",
                        column: x => x.UserImageFilesId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarFuelStatus = table.Column<int>(type: "int", nullable: false),
                    ...
                    CarMaintenanceKM = table.Column<int>(type: "int", nullable: false),
                    IsCarMaintenanceArrived = table.Column<bool>(type: "bit", nullable: false),
                    CarTypeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CarEngineTypeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CompanyId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CarIMEI = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CarStatus = table.Column<bool>(type: "bit", nullable: false),
                    IsCarCommercial = table.Column<bool>(type: "bit", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CarImageFilesId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarReservationProcesses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CarReservationProcesses_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubReasonForRequest = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ReasonForRequestDetails = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RouteStart = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RouteEnd = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ReservationStatus = table.Column<bool>(type: "bit", nullable: false),
                    PeopleCount = table.Column<int>(type: "int", nullable: false),
                    DriverCount = table.Column<int>(type: "int", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarReservationApprovals", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CarReservationApprovals_CarReservations_CarReservationId",
                        column: x => x.CarReservationId,
                        principalTable: "CarReservations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CarReservationApprovals_ReservationStatuses_ReservationStatusId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarReservationUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CarReservationUsers_CarReservations_CarReservationId",
                        column: x => x.CarReservationId,
                        principalTable: "CarReservations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "CarReservationUserCarReservationUserImageFile",
                columns: table => new
                {
                    CarReservationUserImageFilesId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CarReservationUsersId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarReservationUserCarReservationUserImageFile", x => new { x.CarReservationUserImageFilesId, x.CarReservationUsersId });
                    table.ForeignKey(
                        name: "FK_CarReservationUserCarReservationUserImageFile_CarReservationUsers_CarReservationUsersId",
                        column: x => x.CarReservationUsersId,
                        principalTable: "CarReservationUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CarReservationUserCarReservationUserImageFile_Files_CarReservationUserImageFilesId",
                        column: x => x.CarReservationUserImageFilesId,
                        principalTable: "Files",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUserUserImageFile_UserImageFilesId",
                table: "AppUserUserImageFile",
                column: "UserImageFilesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarReservationApprovals_CarReservationId",
                table: "CarReservationApprovals",
                column: "CarReservationId");

            migrationBuilder.CreateIndex(
                name: "IX_CarReservationApprovals_ReservationStatusId",
                table: "CarReservationApprovals",
                column: "ReservationStatusId");

            migrationBuilder.CreateIndex(
                name: "IX_CarReservationProcesses_CarId",
                table: "CarReservationProcesses",
                column: "CarId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarReservationUserCarReservationUserImageFile_CarReservationUsersId",
                table: "CarReservationUserCarReservationUserImageFile",
                column: "CarReservationUsersId");

            migrationBuilder.CreateIndex(
                name: "IX_CarReservationUsers_CarReservationId",
                table: "CarReservationUsers",
                column: "CarReservationId");
