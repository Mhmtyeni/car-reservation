using AracTakip.Application.Features.Commands.AuthorizationEndpoint.AssignRoleEndpoint;
using AracTakip.Application.Features.Queries.AuthorizationEndpoint.GetRolesToEndpoints;
using MediatR;
